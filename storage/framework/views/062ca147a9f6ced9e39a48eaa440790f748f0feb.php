...
<head>
    ...
    <nama><?php echo $__env->yieldContent('nama_web'); ?></nama>
...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
    <div id="wrapper">
        <?php echo $__env->make('partial.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content">
                <?php echo $__env->make('partial.layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- Begin Page Content -->
                <main class="py-4">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-nama" id="exampleModalLabel">Ready to Leave?</h5>
...
</html><?php /**PATH C:\Users\Public\Documents\bansat\resources\views/partial/template.blade.php ENDPATH**/ ?>