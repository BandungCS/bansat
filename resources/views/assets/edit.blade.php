...
@section('content')
    <div class="container mt-0 mb-3">
        <div class="row">
            <div class="col-md-12">
                <!-- Page Heading -->        
            <h1 class="h3 mb-3 text-gray-800 font-weight-bold text-center">Edit Data assets</h1>
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('assets.update', $assets->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('konten') is-invalid @enderror" name="konten" rows="5" placeholder="Masukkan Konten assets">{{ old('konten', $assets->content) }}</textarea>
